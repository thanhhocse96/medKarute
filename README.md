...
| **[md-to-docx](https://github.com/pickle-an/md-to-docx-skill)** (agent skill) | Convert `writing/*.md` → formatted Word `.docx` (versioning, TOC, front-matter). Vendored copy → [`.agents/skills/md-to-docx/`](.agents/skills/md-to-docx/) (Python). Update reference: [awesome-copilot `SKILL.md`](https://github.com/github/awesome-copilot/blob/main/skills/md-to-docx/SKILL.md). Not an MCP |
